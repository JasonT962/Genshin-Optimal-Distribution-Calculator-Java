...
public class ChioriCalculator extends DamageCalculator {
    public double Damage(Player player) {
        ...
        if (player.damageScaling == Player.scaling.Attack) {
            return ((totalAttack * skillMultiplier) + (totalDefence * dualMultiplier)) * damageBonus * defDamageReduction * resDamageReduction * reactionDamage;
        }
